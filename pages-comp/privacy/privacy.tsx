      ...
      <div className="max-w-7xl mx-auto py-40">
        ...
        <div className="flex flex-col gap-5 py-10">
          ...
          <div className="privacy-item">
            ...
            <p className="text-lg">
              <span className="font-bold">1.1.</span> Shaxsiy Ma‘lumotlar: Biz,
              kurslarga yozilishingizda, so‘rovlar qilishingizda yoki
              veb-saytimiz bilan munosabatda bo‘lishingizda ism, elektron pochta
              manzili, pochta manzili, telefon raqami va to‘lov ma‘lumotlari
              kabi shaxsiy ma‘lumotlarni to‘plab olamiz.
            </p>
            <p className="text-lg">
              ...
              qandaydir ma‘lumotlar, shu jumladan, IP manzilingiz, brauzer turi,
          ...
          <div className="privacy-item">
            ...
            <p className="text-lg">
              ...
              yoki bizning huquqlarimizni himoya qilish uchun talab qilinishida
              uchta taraflar.
            </p>
          </div>
          <div className="privacy-item">
          ...
          <div className="privacy-item">
            ...
            <p className="text-lg">
              ...
              Siyosati da belgilangan maqsadlarni amalga oshirish uchun shaxsiy
              ma‘lumotlaringizni faqat shu muddatgacha saqlaymiz, qonun
              to‘g‘risida uzun muddatli saqlash talab qilinishi hamda kerak
              bo‘lishi shart.
            </p>
          </div>
          <div className="privacy-item">
